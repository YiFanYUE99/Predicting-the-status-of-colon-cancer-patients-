# -*- coding: utf-8 -*-
"""
Created on Thu Apr 21 16:12:09 2022
...
#拟合模型
lr = LogisticRegression(penalty='l1', C=1000, solver='liblinear', multi_class='ovr')
lr.fit(X_train, y_train)
#查看模型正确率
...
weights.to_csv("D:\\作业\\210224结肠癌文章初稿\\负谱\\MSRT\\权重.csv",header=True,index=True);
