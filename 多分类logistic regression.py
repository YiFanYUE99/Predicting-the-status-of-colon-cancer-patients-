# -*- coding: utf-8 -*-
"""
Created on Thu Oct 28 10:16:42 2021
...
#拟合模型
lr = LogisticRegression(penalty='l1', C=100000, solver='liblinear', multi_class='ovr')
lr.fit(X_train, y_train)
#查看模型正确率
...
weights=weights.T
weights.to_csv("D:\\作业\\210224结肠癌文章初稿\\LOG2\\multivariate\\逻辑回归\\权重.csv",header=True,index=True);
